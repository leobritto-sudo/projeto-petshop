...
public class NotaFiscal extends javax.swing.JFrame {
     ...
     */
    public NotaFiscal(List<Prod> listaProdutos) {
        initComponents();
        ...
        for (Prod produto : listaProdutos){
            ...
            valorFinal += produto.getValor() * Double.parseDouble(produto.getQtd());
            
        }
        
        lblTotal.setText(lblTotal.getText() + Double.toString(valorFinal));
    ...
    private void initComponents() {
        ...
        jLabel1.setText("PETSHOP UAM");

        jLabel2.setText("ENDEREÇO: Av.Paulista 2000 - SÃO PAULO, SP ");

        jLabel3.setText("CNPJ: XXXXXXXXXX");
        ...
        jLabel8.setText("Data e Horario :");
